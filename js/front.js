...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const sbToggleBtn = document.getElementById('toggle-btn'),
		  ...
		  navbarText1  = document.querySelector('.navbar-text.nav1'),
		  navbarText2  = document.querySelector('.navbar-text.nav2'),
		  navbarText3  = document.querySelector('.navbar-text.nav3'),
		  navbarText4  = document.querySelector('.navbar-text.nav4'),
		  navbarText5  = document.querySelector('.navbar-text.nav5'),
		  navbarText6  = document.querySelector('.navbar-text.nav6'),
		  navbarText7  = document.querySelector('.navbar-text.nav7'),
    ...
    if (sideNavbar, navbarText1, navbarText2) {
        sbToggleBtn.addEventListener('click', function (e) {
            e.preventDefault();
            this.classList.toggle('active');

            sideNavbar.classList.toggle('shrinked');
			navbarText1.classList.toggle('hidden');
			navbarText2.classList.toggle('hidden');
			navbarText3.classList.toggle('hidden');
			navbarText4.classList.toggle('hidden');
			navbarText5.classList.toggle('hidden');
			navbarText6.classList.toggle('hidden');
			navbarText7.classList.toggle('hidden');
